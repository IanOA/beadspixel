...
const I18N = {
  "zh-TW": {
    ...
    navCta: "開始製作",
    // Hero
    heroBadge: "免費線上工具 · 無需註冊",
    heroTitle: "把喜歡的圖片<br>變成拼豆圖紙",
    heroDesc: "上傳任何圖片，自動轉換成像素風格的拼豆圖紙。支援 9 大品牌、992 種真實色號，下載 PDF 就能開始拼豆。",
    heroBtn: "上傳圖片開始",
    heroGhost: "了解使用方式",
    brandsLabel: "支援品牌",
    // Intro
    introTitle: "什麼是拼豆？",
    introDesc: "拼豆（Fuse Beads）是一種小型塑膠珠子，放在模板板上排列出圖案後，用熨斗加熱讓珠子融合在一起，就能做出獨一無二的像素風格作品。不管是角色、風景還是文字，都能用拼豆來呈現。",
    // Demo
    demoTitle: "轉換效果預覽",
    demoDesc: "原始圖片經過轉換後，會變成像素風格的拼豆圖紙",
    demoOriginal: "Original",
    demoBeads: "Bead Pattern",
    // Steps
    stepsTitle: "怎麼使用？",
    stepsDesc: "只要四個步驟，就能從圖片產生拼豆圖紙",
    step1: "上傳圖片", step1d: "選擇或拖曳你喜歡的圖片",
    step2: "調整設定", step2d: "選擇品牌、板子大小、顏色數量",
    step3: "一鍵轉換", step3d: "自動產生像素風格拼豆圖紙",
    step4: "下載圖紙", step4d: "匯出 PNG 或 PDF，開始拼豆",
    // Features
    featTitle: "功能特色",
    ...
    // Needs
    needsTitle: "開始拼豆你需要",
    need1: "拼豆珠子", need1d: "選擇你喜歡的品牌",
    need2: "拼豆板", need2d: "方形模板板",
    need3: "助燙紙", need3d: "烘焙紙也可以",
    need4: "熨斗", need4d: "加熱融合珠子",
    // CTA
    ctaTitle: "準備好了嗎？",
    ctaDesc: "上傳一張圖片，馬上開始你的拼豆創作之旅。",
    ctaBtn: "開始製作圖紙",
    // Stats
    statBrands: "支援品牌",
    statColors: "真實色號",
    ...
    faqTitle: "常見問題",
    faq1q: "這個工具是免費的嗎？",
    faq1a: "是的，完全免費，無需註冊，也沒有使用次數限制。",
    faq2q: "我的圖片會被上傳到伺服器嗎？",
    faq2a: "不會。所有處理都在你的瀏覽器中完成，圖片不會離開你的裝置。",
    faq3q: "支援哪些拼豆品牌？",
    ...
    // Footer
    footer: "拼豆圖紙產生器 — 免費線上工具 · 色碼資料來源",
    footerHome: "首頁",
    footerEditor: "圖紙製作",
    footerPrivacy: "隱私權政策",
    footerTerms: "使用條款",
    footerContact: "聯絡我們",
    footerNote: "本工具完全在瀏覽器中運行，不會上傳或儲存任何圖片。",
    // Editor
    editorTitle: "拼豆圖紙產生器",
    editorSubtitle: "上傳圖片，一鍵轉換成拼豆圖紙",
    ...
    brandLabel: "拼豆品牌",
    shapeLabel: "珠子形狀",
    shapeCircle: "圓形", shapeSquare: "方形",
    showGrid: "顯示格線",
    showSymbols: "顯示符號（方便辨識顏色）",
    advancedOpts: "進階選項",
    highlightLines: "加粗線間隔",
    highlightHint: "每隔 N 行加粗格線，方便數格子（0 = 關閉）",
    convertBtn: "轉換圖紙 →",
    resultTitle: "拼豆圖紙",
    zoomIn: "+ 放大", zoomOut: "− 縮小",
    colorList: "顏色清單",
    buyBtn: "購買材料",
    buyHint: "根據色號清單，一鍵前往商城選購所需珠子",
  },
  "zh-CN": {
    navLogo: "拼豆图纸生成器",
    navCta: "开始制作",
    heroBadge: "免费在线工具 · 无需注册",
    heroTitle: "把喜欢的图片<br>变成拼豆图纸",
    heroDesc: "上传任何图片，自动转换成像素风格的拼豆图纸。支持 9 大品牌、992 种真实色号，下载 PDF 就能开始拼豆。",
    heroBtn: "上传图片开始",
    heroGhost: "了解使用方式",
    brandsLabel: "支持品牌",
    introTitle: "什么是拼豆？",
    introDesc: "拼豆（Fuse Beads）是一种小型塑料珠子，放在模板板上排列出图案后，用熨斗加热让珠子融合在一起，就能做出独一无二的像素风格作品。不管是角色、风景还是文字，都能用拼豆来呈现。",
    demoTitle: "转换效果预览",
    demoDesc: "原始图片经过转换后，会变成像素风格的拼豆图纸",
    demoOriginal: "Original",
    demoBeads: "Bead Pattern",
    stepsTitle: "怎么使用？",
    stepsDesc: "只要四个步骤，就能从图片生成拼豆图纸",
    step1: "上传图片", step1d: "选择或拖拽你喜欢的图片",
    step2: "调整设置", step2d: "选择品牌、板子大小、颜色数量",
    step3: "一键转换", step3d: "自动生成像素风格拼豆图纸",
    ...
    needsTitle: "开始拼豆你需要",
    need1: "拼豆珠子", need1d: "选择你喜欢的品牌",
    need2: "拼豆板", need2d: "方形模板板",
    need3: "助烫纸", need3d: "烘焙纸也可以",
    need4: "熨斗", need4d: "加热融合珠子",
    ctaTitle: "准备好了吗？",
    ctaDesc: "上传一张图片，马上开始你的拼豆创作之旅。",
    ctaBtn: "开始制作图纸",
    statBrands: "支持品牌",
    statColors: "真实色号",
    statFree: "免费使用",
    faqTitle: "常见问题",
    faq1q: "这个工具是免费的吗？",
    faq1a: "是的，完全免费，无需注册，也没有使用次数限制。",
    faq2q: "我的图片会被上传到服务器吗？",
    faq2a: "不会。所有处理都在你的浏览器中完成，图片不会离开你的设备。",
    faq3q: "支持哪些拼豆品牌？",
    ...
    footerTerms: "使用条款",
    footerContact: "联系我们",
    footerNote: "本工具完全在浏览器中运行，不会上传或存储任何图片。",
    editorTitle: "拼豆图纸生成器",
    editorSubtitle: "上传图片，一键转换成拼豆图纸",
    ...
    brandLabel: "拼豆品牌",
    shapeLabel: "珠子形状",
    shapeCircle: "圆形", shapeSquare: "方形",
    showGrid: "显示格线",
    showSymbols: "显示符号（方便辨识颜色）",
    advancedOpts: "进阶选项",
    highlightLines: "加粗线间隔",
    highlightHint: "每隔 N 行加粗格线，方便数格子（0 = 关闭）",
    convertBtn: "转换图纸 →",
    resultTitle: "拼豆图纸",
    zoomIn: "+ 放大", zoomOut: "− 缩小",
    colorList: "颜色清单",
    buyBtn: "购买材料",
    buyHint: "根据色号清单，一键前往商城选购所需珠子",
  },
  "en": {
    navLogo: "Bead Pattern Maker",
    navCta: "Get Started",
    heroBadge: "Free Online Tool · No Sign-up",
    heroTitle: "Turn Any Image<br>Into a Bead Pattern",
    heroDesc: "Upload any image and convert it into a pixel-style fuse bead pattern. Supports 9 brands with 992 real color codes. Download as PDF and start crafting.",
    heroBtn: "Upload Image",
    heroGhost: "How It Works",
    brandsLabel: "Supported Brands",
    introTitle: "What Are Fuse Beads?",
    introDesc: "Fuse beads are small plastic beads placed on a pegboard to form patterns. After ironing, the beads melt together to create unique pixel-art style crafts. Characters, landscapes, text — anything can be made with fuse beads.",
    demoTitle: "Conversion Preview",
    demoDesc: "See how an original image transforms into a bead pattern",
    demoOriginal: "Original",
    demoBeads: "Bead Pattern",
    stepsTitle: "How It Works",
    stepsDesc: "Just four steps to go from image to bead pattern",
    step1: "Upload Image", step1d: "Select or drag your favorite image",
    step2: "Adjust Settings", step2d: "Choose brand, board size, color count",
    step3: "Convert", step3d: "Auto-generate pixel-style bead pattern",
    ...
    need1: "Fuse Beads", need1d: "Pick your favorite brand",
    need2: "Pegboard", need2d: "Square pegboard",
    need3: "Ironing Paper", need3d: "Parchment paper works too",
    need4: "Iron", need4d: "To melt beads together",
    ctaTitle: "Ready to Start?",
    ctaDesc: "Upload an image and begin your fuse bead journey.",
    ctaBtn: "Start Making",
    statBrands: "Brands",
    statColors: "Color Codes",
    statFree: "Free to Use",
    faqTitle: "FAQ",
    faq1q: "Is this tool free?",
    faq1a: "Yes, completely free. No sign-up required and no usage limits.",
    faq2q: "Are my images uploaded to a server?",
    faq2a: "No. All processing happens in your browser. Your images never leave your device.",
    ...
    footerNote: "This tool runs entirely in your browser. No images are uploaded or stored.",
    editorTitle: "Bead Pattern Maker",
    editorSubtitle: "Upload an image, convert to bead pattern",
    ...
    shapeLabel: "Bead Shape",
    shapeCircle: "Circle", shapeSquare: "Square",
    showGrid: "Show Grid",
    showSymbols: "Show Symbols (for color identification)",
    advancedOpts: "Advanced Options",
    highlightLines: "Highlight Line Interval",
    highlightHint: "Draw bold lines every N rows/columns for easier counting (0 = off)",
    convertBtn: "Convert →",
    resultTitle: "Bead Pattern",
    zoomIn: "+ Zoom In", zoomOut: "− Zoom Out",
    colorList: "Color List",
    buyBtn: "Buy Materials",
    buyHint: "Go to the shop to purchase the beads you need based on the color list",
  },
  "ja": {
    navLogo: "アイロンビーズ図案メーカー",
    navCta: "作成開始",
    heroBadge: "無料オンラインツール · 登録不要",
    heroTitle: "好きな画像を<br>ビーズ図案に変換",
    heroDesc: "画像をアップロードするだけで、ピクセル風のアイロンビーズ図案を自動生成。9ブランド・992色に対応。PDFでダウンロードしてすぐ作れます。",
    heroBtn: "画像をアップロード",
    heroGhost: "使い方を見る",
    brandsLabel: "対応ブランド",
    introTitle: "アイロンビーズとは？",
    introDesc: "アイロンビーズは小さなプラスチックビーズをペグボードに並べて図案を作り、アイロンで加熱して溶着させるクラフトです。キャラクター、風景、文字など、何でもピクセルアート風に表現できます。",
    demoTitle: "変換プレビュー",
    demoDesc: "元の画像がピクセル風のビーズ図案に変換されます",
    demoOriginal: "Original",
    demoBeads: "Bead Pattern",
    stepsTitle: "使い方",
    stepsDesc: "4ステップで画像からビーズ図案を作成",
    step1: "画像アップロード", step1d: "好きな画像を選択またはドラッグ",
    step2: "設定調整", step2d: "ブランド・ボードサイズ・色数を選択",
    step3: "ワンクリック変換", step3d: "ピクセル風ビーズ図案を自動生成",
    ...
    needsTitle: "必要なもの",
    need1: "アイロンビーズ", need1d: "お好みのブランドを選択",
    need2: "ペグボード", need2d: "四角形プレート",
    need3: "アイロンペーパー", need3d: "クッキングシートでもOK",
    need4: "アイロン", need4d: "ビーズを溶着",
    ctaTitle: "準備はできましたか？",
    ctaDesc: "画像をアップロードして、アイロンビーズ作りを始めましょう。",
    ctaBtn: "図案を作成する",
    statBrands: "対応ブランド",
    statColors: "カラーコード",
    statFree: "完全無料",
    faqTitle: "よくある質問",
    faq1q: "このツールは無料ですか？",
    faq1a: "はい、完全無料です。登録不要で、使用回数の制限もありません。",
    faq2q: "画像はサーバーにアップロードされますか？",
    faq2a: "いいえ。すべての処理はブラウザ内で行われ、画像がデバイスから送信されることはありません。",
    ...
    footerNote: "このツールはブラウザ上で完全に動作し、画像のアップロードや保存は行いません。",
    editorTitle: "アイロンビーズ図案メーカー",
    editorSubtitle: "画像をアップロード、ワンクリックで変換",
    ...
    brandLabel: "ビーズブランド",
    shapeLabel: "ビーズ形状",
    shapeCircle: "丸形", shapeSquare: "四角形",
    showGrid: "グリッド表示",
    showSymbols: "記号表示（色の識別用）",
    advancedOpts: "詳細オプション",
    highlightLines: "太線の間隔",
    highlightHint: "N行ごとに太線を表示、マス目を数えやすくします（0 = オフ）",
    convertBtn: "変換 →",
    resultTitle: "ビーズ図案",
    zoomIn: "+ 拡大", zoomOut: "− 縮小",
    colorList: "カラーリスト",
    buyBtn: "材料を購入",
    buyHint: "カラーリストに基づいて、必要なビーズをショップで購入",
  },
  "ko": {
    navLogo: "비즈 도안 메이커",
    navCta: "시작하기",
    heroBadge: "무료 온라인 도구 · 가입 불필요",
    heroTitle: "좋아하는 이미지를<br>비즈 도안으로 변환",
    heroDesc: "이미지를 업로드하면 픽셀 스타일의 비즈 도안으로 자동 변환됩니다. 9개 브랜드, 992가지 실제 색상 코드를 지원합니다.",
    heroBtn: "이미지 업로드",
    heroGhost: "사용 방법 보기",
    brandsLabel: "지원 브랜드",
    introTitle: "비즈란 무엇인가요?",
    introDesc: "퓨즈 비즈는 작은 플라스틱 비즈를 보드 위에 배열하여 도안을 만든 후, 다리미로 가열하여 녹여 붙이는 공예입니다. 캐릭터, 풍경, 글자 등 무엇이든 픽셀 아트 스타일로 표현할 수 있습니다.",
    demoTitle: "변환 미리보기",
    demoDesc: "원본 이미지가 픽셀 스타일의 비즈 도안으로 변환됩니다",
    demoOriginal: "Original",
    demoBeads: "Bead Pattern",
    stepsTitle: "사용 방법",
    stepsDesc: "4단계로 이미지에서 비즈 도안을 만들 수 있습니다",
    step1: "이미지 업로드", step1d: "좋아하는 이미지를 선택하거나 드래그",
    step2: "설정 조정", step2d: "브랜드, 보드 크기, 색상 수 선택",
    step3: "원클릭 변환", step3d: "픽셀 스타일 비즈 도안 자동 생성",
    ...
    needsTitle: "필요한 것들",
    need1: "퓨즈 비즈", need1d: "좋아하는 브랜드 선택",
    need2: "비즈 보드", need2d: "사각형 보드",
    need3: "다림질 종이", need3d: "베이킹 페이퍼도 가능",
    need4: "다리미", need4d: "비즈를 녹여 붙이기",
    ctaTitle: "준비되셨나요?",
    ctaDesc: "이미지를 업로드하고 비즈 만들기를 시작하세요.",
    ctaBtn: "도안 만들기",
    statBrands: "지원 브랜드",
    statColors: "색상 코드",
    statFree: "무료 사용",
    faqTitle: "자주 묻는 질문",
    faq1q: "이 도구는 무료인가요?",
    faq1a: "네, 완전 무료입니다. 가입이 필요 없고 사용 횟수 제한도 없습니다.",
    faq2q: "이미지가 서버에 업로드되나요?",
    faq2a: "아니요. 모든 처리는 브라우저에서 이루어지며, 이미지가 기기를 떠나지 않습니다.",
    ...
    footerTerms: "이용약관",
    footerContact: "문의하기",
    footerNote: "이 도구는 브라우저에서 완전히 실행되며, 이미지를 업로드하거나 저장하지 않습니다.",
    editorTitle: "비즈 도안 메이커",
    editorSubtitle: "이미지 업로드, 원클릭 변환",
    ...
    brandLabel: "비즈 브랜드",
    shapeLabel: "비즈 모양",
    shapeCircle: "원형", shapeSquare: "사각형",
    showGrid: "격자 표시",
    showSymbols: "기호 표시 (색상 식별용)",
    advancedOpts: "고급 옵션",
    highlightLines: "굵은 선 간격",
    highlightHint: "N행마다 굵은 선을 표시하여 칸 세기 편리 (0 = 끄기)",
    convertBtn: "변환 →",
    resultTitle: "비즈 도안",
    zoomIn: "+ 확대", zoomOut: "− 축소",
    colorList: "색상 목록",
    buyBtn: "재료 구매",
    buyHint: "색상 목록에 따라 필요한 비즈를 쇼핑몰에서 구매하세요",
  }
};
...
function initializeLogo() {
  ...
  if (logoCanvases.length) {
    ...
    var logoPatterns = [logoHeart, logoStar];
    var logoPals = [
      ['#faf7f2','#ffccd5','#ff8fa3','#f06449'],
      ['#faf7f2','#c1f0db','#36c9a7','#0a8967'],
      ['#faf7f2','#d5c4f7','#9b7bf7','#6a3fd4'],
      ['#faf7f2','#ffe5a0','#ffc53d','#e6a200']
    ];
    var logoIdx = 0;

    function drawLogo() {
      // Sync with landing page demo if available
      var i = (typeof window._beadDemoIdx === 'number') ? window._beadDemoIdx : logoIdx;
      var pal = logoPals[i % logoPals.length];
      var pat = logoPatterns[i % logoPatterns.length];
      logoCanvases.forEach(function(c) {
        var s = c.width;
        ...
        var rr = s * 0.18;
        ctx.moveTo(rr, 0);
        ctx.lineTo(s - rr, 0); ctx.quadraticCurveTo(s, 0, s, rr);
